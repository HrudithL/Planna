        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              View, search, and filter all courses in the system.
            </p>
            <Button asChild variant="outline">
              <Link to="/dashboard/admin/courses">Go to Courses</Link>
            </Button>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            ...
            <Button asChild variant="outline">
              <Link to="/dashboard/admin/courses/upload">Upload JSON</Link>
            </Button>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Create and manage preset plans for students.
            </p>
            <Button asChild variant="outline">
              <Link to="/dashboard/admin/presets">Go to Presets</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
